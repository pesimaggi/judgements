...
| **[regulations-and-travaux.md](regulations-and-travaux.md)** | A research spike from September 2026 on three corpora we do not hold: reglugerðir, Althingi preparatory works, and repealed acts. Its §1 (the reglugerðir ingest and the lagastoð link) and §2.1 (the Alþingi links and footnotes) have shipped; the rest has not, and it says so at the top. §1.8 and §1.9 record what building it changed about the plan. | What the reglugerd.is API actually serves, why the Althingi linkage is already in our hands and being discarded, and the argument against ingesting repealed acts wholesale. Read it as a proposal, not a description. |
