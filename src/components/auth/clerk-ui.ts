...
export const localization: LocalizationResource = {
  ...
  signIn: { ...isIS.signIn, start: { ...isIS.signIn?.start,
    ...
    subtitle: "Veldu innskráningaraðferð.", subtitleCombined: "Veldu innskráningaraðferð.",
...
export const appearance: Appearance = {
  ...
  layout: { socialButtonsPlacement: "top", socialButtonsVariant: "blockButton", showOptionalFields: false },
  elements: {
    ...
    socialButtonsBlockButton__microsoft: { order: -1 },
  },
};
